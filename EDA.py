...
$python EDA.py getEDA "/Users/directory/of/your/files"
in this directory you should have all your EDA log files along with the fort.99 from your 
electro calculation. So for a bimolecular TS, 5 '.log' files and 1 fort.99 file. 
...
if __name__ == '__main__':
    ...
    #how do I allow add a second parameter in the command line?